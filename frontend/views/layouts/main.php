...
<div class="top">
    <div class="center clear">
        ...
        <div class="right fr">
            ...
            <a href="<?=\yii\helpers\Url::to(['site/login'])?>" target="_blank">登录</a>
            <a href="<?=\yii\helpers\Url::to(['site/signup'])?>" target="_blank">注册</a>
            <?php endif;?>
...
<div class="nav">
    <div class="center">
        ...
        <ul class="nav-inner fl">
            ...
            <li><a href="<?=\yii\helpers\Url::to(['choice/cake','war'=>'','obj'=>'','mat'=>'','des'=>''])?>" target="_blank" title="蛋糕">蛋糕</a></li>
