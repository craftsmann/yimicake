...
<?php $this->beginPage();?>
    ...
    <section class="panel">
        <div class="panel-body">
            ...
            <input id="f-photo" type="hidden" name="FuserForm[photo]" value="<?=$model->photo?>">
            <input id="f-photo" type="hidden" name="FuserForm[id]" value="<?=$model->id?>">
            <div class="form-group">
                <label for="inputPassword1" class="col-lg-2 col-sm-2 control-label">用户名</label>
                <div class="col-lg-10">
                    <input type="text" class="form-control" name="FuserForm[username]" placeholder="用户名" value="<?=$model->username?>">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <input type="email" class="form-control" name="FuserForm[email]"  placeholder="Email" value="<?=$model->email?>">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <input type="text" class="form-control" name="FuserForm[phone]" value="<?=$model->phone?>">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <input type="text" class="form-control" name="FuserForm[qq]" value="<?=$model->qq?>">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <div>
                        <label>
                            <input type="radio" name="FuserForm[sex]" value="男" <?= $model->sex=='男'?'checked':''?>>
                            <span>男</span>
                            <input type="radio" name="FuserForm[sex]" value="女" <?= $model->sex=='女'?'checked':''?>>
                            女
                        </label>
                    </div>
                </div>
