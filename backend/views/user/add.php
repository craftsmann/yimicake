...
<?php $this->beginPage();?>
    ...
    <section class="panel">
        <div class="panel-body">
            <?php echo Html::beginForm(['user/add'],'post',['class'=>'form-horizontal','id'=>'sub-form'])?>

            <!--            <form class="form-horizontal" role="form">-->
            <input id="f-photo" type="hidden" name="UserForm[photo]">
            <div class="form-group">
                <label for="inputPassword1" class="col-lg-2 col-sm-2 control-label">用户名</label>
                <div class="col-lg-10">
                    <input type="text" class="form-control" name="UserForm[username]" placeholder="用户名">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <input type="password" class="form-control" name="UserForm[password]" placeholder="密码">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <input type="email" class="form-control" name="UserForm[email]"  placeholder="Email">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <input type="text" class="form-control" name="UserForm[phone]">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <input type="text" class="form-control" name="UserForm[qq]">
                ...
                <div class="col-lg-10">
                    <div>
                        <label>
                            ...
                            <span>男</span>
                            <input type="radio" name="UserForm[sex]" value="女">
                            女
                        </label>
                    </div>
                </div>
