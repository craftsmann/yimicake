...
<?php $this->beginPage();?>
    ...
    <section class="panel">
        <div class="panel-body">
            <?php echo Html::beginForm(['menu/add'],'post',['class'=>'form-horizontal','id'=>'sub-form'])?>

            <div class="form-group">
                <label for="inputPassword1" class="col-lg-2 col-sm-2 control-label">名称</label>
                <div class="col-lg-10">
                    <input type="text" class="form-control" name="MenuForm[name]" placeholder="菜单名称">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <input type="text" class="form-control" name="MenuForm[route]" placeholder="路由">
                </div>
            </div>
            <div class="form-group">
                <label class="col-lg-2 col-sm-2 control-label">排序</label>
                <div class="col-lg-10">
                    <input type="text" class="form-control" name="MenuForm[order]" placeholder="排序">
                </div>
            </div>
            <div class="form-group">
                <label class="col-lg-2 col-sm-2 control-label">icon</label>
                <div class="col-lg-10">
                    <input type="text" class="form-control" name="MenuForm[data]" placeholder="icon名称">
                </div>
            </div>
            <div class="form-group">
